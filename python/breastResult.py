...
fileHandler = logging.FileHandler("python/logs/breastResult.log")
...
def saveBreastResult(requestData):
        try:
			...
			charset=config["charset"],
                ...
                with db:
                        with db.cursor() as cur:
                                ...
                                print('{"success": "yes", "message": "Save Result Success"}')
