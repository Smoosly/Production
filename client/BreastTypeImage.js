let typeImages = [
  {
    type: 1,
    represent: require("@/assets/bratabase/1/1-1.png"),
    subImages: [
  ...
  {
    type: 2,
    represent: require("@/assets/bratabase/2/2-1.png"),
    subImages: [
  ...
  {
    type: 4,
    represent: require("@/assets/bratabase/4/4-1.png"),
    subImages: [
  ...
  {
    type: 5,
    represent: require("@/assets/bratabase/5/5-1.png"),
    subImages: [
      ...
      // {"id": 21, "path": require("@/assets/bratabase/5/5-5.png")},
    ],
  },
  {
    type: 6,
  ...
  {
    type: 7,
    represent: require("@/assets/bratabase/7/7-1.png"),
    subImages: [
  ...
  {
    type: 8,
    represent: require("@/assets/bratabase/8/8-1.png"),
    subImages: [
  ...
  {
    type: 9,
    represent: require("@/assets/bratabase/9/9-1.png"),
    subImages: [
  ...
  {
    type: 10,
    represent: require("@/assets/bratabase/10/10-1.png"),
    subImages: [{ id: 34, path: require("@/assets/bratabase/10/10-1.png") }],
  },
  {
    type: 11,
  ...
  {
    type: 13,
    represent: require("@/assets/bratabase/13/13-1.png"),
    subImages: [
  ...
  {
    type: 15,
    represent: require("@/assets/bratabase/15/15-1.png"),
    subImages: [
  ...
  {
    type: 16,
    represent: require("@/assets/bratabase/16/16-1.png"),
    subImages: [
  ...
  {
    type: 17,
    represent: require("@/assets/bratabase/17/17-1.png"),
    subImages: [
  ...
  {
    type: 18,
    represent: require("@/assets/bratabase/18/18-1.png"),
    subImages: [{ id: 66, path: require("@/assets/bratabase/18/18-1.png") }],
  },
  {
    type: 19,
    represent: require("@/assets/bratabase/19/19-1.png"),
    subImages: [
  ...
  {
    type: 20,
    represent: require("@/assets/bratabase/20/20-1.png"),
    subImages: [
  ...
  {
    type: 21,
    represent: require("@/assets/bratabase/21/21-1.png"),
    subImages: [{ id: 74, path: require("@/assets/bratabase/21/21-1.png") }],
  },
  {
    type: 22,
  ...
  {
    type: 23,
    represent: require("@/assets/bratabase/23/23-1.png"),
    subImages: [
